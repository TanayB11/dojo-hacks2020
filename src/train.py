...
with h5py.File('../data/temp100/compressed/trainX.h5', 'r') as f:
    trainX = f['trainX'][:]
with h5py.File('../data/temp100/compressed/testX.h5', 'r') as f:
    testX = f['testX'][:]
with h5py.File('../data/temp100/compressed/trainY.h5', 'r') as f:
    trainY = f['trainY'][:]
with h5py.File('../data/temp100/compressed/testY.h5', 'r') as f:
    testY = f['testY'][:]
